...
public class DAOManager {
    ...
    private DAOManager() { //Constructor privado para que no se pueda llamar las veces que se quiera
        this.conn = null;
        this.URL = "jdbc:mysql://localhost:3307/FichajesEmpresa?autoReconnect=true&useSSL=false"; //Enlazo la dirección del servidor y de la base de datos a usar
        this.USER = "root"; //Usuario de la BBDD
        this.PASS = "secret"; //Clave de la BBDD
    }
